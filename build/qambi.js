...
var Part = (function () {
  ...
  _createClass(Part, [{
    ...
    value: function addEvent(event) {
      if (event instanceof _MIDIEvent.MIDIEvent === false && event instanceof _AudioEvent.AudioEvent === false) {
        return;
      }
      event.state = 'new';
  ...
  */
  ...
  _createClass(Song, [{
    ...
    value: function addTrack(track) {
      if (track instanceof _Track.Track === false) {
        return;
      }
