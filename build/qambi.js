  ...
  */
  ...
  function Song(settings) {
    ...
    */
    ...
    this.scheduler = new _Scheduler2['default'](this);
  }
  ...
  _createClass(Song, [{
    ...
    value: function update() {
      ...
      if (this._numberOfTracksChanged === true) {
        ...
        Array.from(this._tracksMap.values()).forEach(function (track) {
          if (track.state === 'removed') {
            _this2._tracksMap['delete'](track.id);
          } else {
            track.state = 'clean';
      ...
      try {
        for (var _iterator4 = this._tracks[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          var track = _step4.value;
          ...
          try {
            for (var _iterator5 = track._newEvents.values()[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
          ...
          try {
            for (var _iterator6 = track._newParts.values()[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
      ...
      if (this._numberOfPartsChanged === true) {
        ...
        Array.from(this._partsMap.values()).forEach(function (part) {
          ...
          if (part.state === 'removed') {
            _this2._partsMap['delete'](part.id);
          } else {
            part.state = 'clean';
      ...
      if (this._numberOfEventsChanged === true) {
        ...
        Array.from(this._eventsMap.values()).forEach(function (event) {
          if (event.state === 'removed') {
            ...
            _this2._eventsMap['delete'](event.id);
          } else {
            event.state = 'clean';
