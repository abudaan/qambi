...
!function(e,i){if("function"==typeof define&&define.amd)define(["exports","./qambi","./song","./sampler","./init_audio","./init_midi","./settings"],i);else if("undefined"!=typeof exports)i(exports,require("./qambi"),require("./song"),require("./sampler"),require("./init_audio"),require("./init_midi"),require("./settings"));else{var n={exports:{}};i(n.exports,e.qambi,e.song,e.sampler,e.init_audio,e.init_midi,e.settings),e.init=n.exports}}(this,function(e,i,n,t,r,o,a){"use strict";function s(e){return e&&e.__esModule?e:{"default":e}}function u(e){var i=new t.Sampler;return new Promise(function(n,t){i.parseSampleData(e).then(function(){return n(i)})})}function d(){var e=arguments.length<=0||void 0===arguments[0]?null:arguments[0],i=[(0,r.initAudio)(),(0,o.initMIDI)()],t=void 0;if(null!==e){t=Object.keys(e);var s=t.indexOf("settings");-1!==s&&((0,a.updateSettings)(e.settings),t.splice(s,1));var d=!0,f=!1,m=void 0;try{for(var c,g=t[Symbol.iterator]();!(d=(c=g.next()).done);d=!0){var p=c.value,v=e[p];"Song"===v.type?i.push(n.Song.fromMIDIFile(v.url)):"Instrument"===v.type&&i.push(u(v))}}catch(b){f=!0,m=b}finally{try{!d&&g["return"]&&g["return"]()}finally{if(f)throw m}}}return new Promise(function(e,n){Promise.all(i).then(function(i){var n={};i.forEach(function(e,i){0===i?(n.legacy=e.legacy,n.mp3=e.mp3,n.ogg=e.ogg):1===i?(n.midi=e.midi,n.webmidi=e.webmidi):n[t[i-2]]=e}),console.log("qambi",l["default"].version),e(n)},function(e){n(e)})})}Object.defineProperty(e,"__esModule",{value:!0}),e.Blob=e.rAF=e.getUserMedia=void 0,e.init=d;var l=s(i);e.getUserMedia=function(){return"undefined"!=typeof navigator?navigator.getUserMedia||navigator.webkitGetUserMedia||navigator.mozGetUserMedia||navigator.msGetUserMedia:function(){console.warn("getUserMedia is not available")}}(),e.rAF=function(){return"undefined"!=typeof navigator?window.requestAnimationFrame||window.webkitRequestAnimationFrame:function(){console.warn("requestAnimationFrame is not available")}}(),e.Blob=function(){return"undefined"!=typeof navigator?window.Blob||window.webkitBlob:function(){console.warn("Blob is not available")}}()});
...
!function(t,e){if("function"==typeof define&&define.amd)define(["exports","./util","webmidiapishim"],e);else if("undefined"!=typeof exports)e(exports,require("./util"),require("webmidiapishim"));else{var n={exports:{}};e(n.exports,t.util,t.webmidiapishim),t.init_midi=n.exports}}(this,function(t,e){"use strict";function n(){u=Array.from(r.inputs.values()),u.sort(function(t,e){return t.name.toLowerCase()<=e.name.toLowerCase()?1:-1});var t=!0,e=!1,n=void 0;try{for(var i,o=u[Symbol.iterator]();!(t=(i=o.next()).done);t=!0){var d=i.value;c.set(d.id,d),a.push(d.id)}}catch(l){e=!0,n=l}finally{try{!t&&o["return"]&&o["return"]()}finally{if(e)throw n}}s=Array.from(r.outputs.values()),s.sort(function(t,e){return t.name.toLowerCase()<=e.name.toLowerCase()?1:-1});var p=!0,v=!1,g=void 0;try{for(var m,M=s[Symbol.iterator]();!(p=(m=M.next()).done);p=!0){var y=m.value;f.set(y.id,y),I.push(y.id)}}catch(l){v=!0,g=l}finally{try{!p&&M["return"]&&M["return"]()}finally{if(v)throw g}}}function i(){return new Promise(function(t,e){"undefined"==typeof navigator?(o=!0,t({midi:!1})):"undefined"!=typeof navigator.requestMIDIAccess?!function(){var i=void 0,a=void 0,I=void 0;navigator.requestMIDIAccess().then(function(e){r=e,"undefined"!=typeof e._jazzInstances?(i=e._jazzInstances[0]._Jazz.version,a=!0):(I=!0,a=!0),n(),e.onconnect=function(t){console.log("device connected",t),n()},e.ondisconnect=function(t){console.log("device disconnected",t),n()},o=!0,t({jazz:i,midi:a,webmidi:I,inputs:u,outputs:s,inputsById:c,outputsById:f})},function(t){e("Something went wrong while requesting MIDIAccess",t)})}():(o=!0,t({midi:!1}))})}Object.defineProperty(t,"__esModule",{value:!0}),t.getMIDIInputById=t.getMIDIOutputById=t.getMIDIInputIds=t.getMIDIOutputIds=t.getMIDIInputs=t.getMIDIOutputs=t.getMIDIAccess=void 0,t.initMIDI=i;var r=void 0,o=!1,u=[],s=[],a=[],I=[],c=new Map,f=new Map,d=function(){return o!==!1?(t.getMIDIAccess=d=function(){return r},d()):(console.warn("please call qambi.init() first"),!1)};t.getMIDIAccess=d;var l=function(){return o!==!1?(t.getMIDIOutputs=l=function(){return s},l()):(console.warn("please call qambi.init() first"),!1)};t.getMIDIOutputs=l;var p=function(){return o!==!1?(t.getMIDIInputs=p=function(){return u},p()):(console.warn("please call qambi.init() first"),!1)};t.getMIDIInputs=p;var v=function(){return o!==!1?(t.getMIDIOutputIds=v=function(){return I},v()):(console.warn("please call qambi.init() first"),!1)};t.getMIDIOutputIds=v;var g=function(){return o!==!1?(t.getMIDIInputIds=g=function(){return a},g()):(console.warn("please call qambi.init() first"),!1)};t.getMIDIInputIds=g;var m=function(e){return o!==!1?(t.getMIDIOutputById=m=function(t){return f.get(t)},m(e)):(console.warn("please call qambi.init() first"),!1)};t.getMIDIOutputById=m;var M=function(e){return o!==!1?(t.getMIDIInputById=M=function(t){return c.get(t)},M(e)):(console.warn("please call qambi.init() first"),!1)};t.getMIDIInputById=M});
},{"./util":45,"webmidiapishim":10}],19:[function(require,module,exports){
!function(e,t){if("function"==typeof define&&define.amd)define(["exports","./init_audio","./eventlistener"],t);else if("undefined"!=typeof exports)t(exports,require("./init_audio"),require("./eventlistener"));else{var n={exports:{}};t(n.exports,e.init_audio,e.eventlistener),e.instrument=n.exports}}(this,function(e,t,n){"use strict";function s(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(e,"__esModule",{value:!0}),e.Instrument=void 0;var i=function(){function e(e,t){for(var n=0;n<t.length;n++){var s=t[n];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(e,s.key,s)}}return function(t,n,s){return n&&e(t.prototype,n),s&&e(t,s),t}}();e.Instrument=function(){function e(){s(this,e),this.scheduledSamples=new Map,this.sustainedSamples=[],this.sustainPedalDown=!1,this.output=null}return i(e,[{key:"connect",value:function(e){this.output=e}},{key:"disconnect",value:function(){this.output=null}},{key:"processMIDIEvent",value:function(e){var s=this,i=e.time/1e3,a=void 0;if(isNaN(i))return void console.error("invalid time value");if(0===i&&(console.error("should not happen"),i=t.context.currentTime),144===e.type)a=this.createSample(e),this.scheduledSamples.set(e.midiNoteId,a),a.output.connect(this.output),a.start(i);else if(128===e.type){if(a=this.scheduledSamples.get(e.midiNoteId),"undefined"==typeof a)return;this.sustainPedalDown===!0?this.sustainedSamples.push(e.midiNoteId):a.stop(i,function(){s.scheduledSamples["delete"](e.midiNoteId)})}else 176===e.type&&(64===e.data1?127===e.data2?(this.sustainPedalDown=!0,(0,n.dispatchEvent)({type:"sustainpedal",data:"down"})):0===e.data2&&(this.sustainPedalDown=!1,this.sustainedSamples.forEach(function(e){a=s.scheduledSamples.get(e),a&&a.stop(i,function(){s.scheduledSamples["delete"](e)})}),this.sustainedSamples=[],(0,n.dispatchEvent)({type:"sustainpedal",data:"up"})):10===e.data1||7===e.data1)}},{key:"allNotesOff",value:function(){this.sustainedSamples=[],this.sustainPedalDown===!0&&(0,n.dispatchEvent)({type:"sustainpedal",data:"up"}),this.sustainPedalDown=!1,this.scheduledSamples.forEach(function(e){e.stop(t.context.currentTime)}),this.scheduledSamples.clear()}},{key:"unschedule",value:function(e){var n=this.scheduledSamples.get(e.midiNoteId);n&&(n.stop(t.context.currentTime),this.scheduledSamples["delete"](e.midiNoteId))}}]),e}()});
...
!function(t,e){if("function"==typeof define&&define.amd)define(["exports","./settings","./note","./midi_event","./midi_note","./part","./track","./song","./instrument","./sampler","./simple_synth","./midifile","./init","./init_audio","./init_midi","./parse_audio","./constants","./eventlistener"],e);else if("undefined"!=typeof exports)e(exports,require("./settings"),require("./note"),require("./midi_event"),require("./midi_note"),require("./part"),require("./track"),require("./song"),require("./instrument"),require("./sampler"),require("./simple_synth"),require("./midifile"),require("./init"),require("./init_audio"),require("./init_midi"),require("./parse_audio"),require("./constants"),require("./eventlistener"));else{var n={exports:{}};e(n.exports,t.settings,t.note,t.midi_event,t.midi_note,t.part,t.track,t.song,t.instrument,t.sampler,t.simple_synth,t.midifile,t.init,t.init_audio,t.init_midi,t.parse_audio,t.constants,t.eventlistener),t.qambi=n.exports}}(this,function(t,e,n,s,I,i,u,r,g,p,a,o,M,m,D,d,l,c){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.Sampler=t.SimpleSynth=t.Instrument=t.Part=t.Track=t.Song=t.MIDINote=t.MIDIEvent=t.getNoteData=t.getMIDIOutputsById=t.getMIDIInputsById=t.getMIDIOutputIds=t.getMIDIInputIds=t.getMIDIOutputs=t.getMIDIInputs=t.getMIDIAccess=t.setMasterVolume=t.getMasterVolume=t.getAudioContext=t.parseMIDIFile=t.parseSamples=t.MIDIEventTypes=t.getSettings=t.updateSettings=t.getGMInstruments=t.getInstruments=t.init=t.version=void 0;var S="1.0.0-beta27",v=function(){return m.context},f={version:S,updateSettings:e.updateSettings,getSettings:e.getSettings,getNoteData:n.getNoteData,init:M.init,setBufferTime:e.setBufferTime,MIDIEventTypes:l.MIDIEventTypes,parseSamples:d.parseSamples,parseMIDIFile:o.parseMIDIFile,getAudioContext:v,getMasterVolume:m.getMasterVolume,setMasterVolume:m.setMasterVolume,getMIDIAccess:D.getMIDIAccess,getMIDIInputs:D.getMIDIInputs,getMIDIOutputs:D.getMIDIOutputs,getMIDIInputIds:D.getMIDIInputIds,getMIDIOutputIds:D.getMIDIOutputIds,getMIDIInputsById:D.getMIDIInputsById,getMIDIOutputsById:D.getMIDIOutputsById,getInstruments:e.getInstruments,getGMInstruments:e.getGMInstruments,addEventListener:function(t,e){return(0,c.addEventListener)(t,e)},removeEventListener:function(t,e){(0,c.removeEventListener)(t,e)},MIDIEvent:s.MIDIEvent,MIDINote:I.MIDINote,Song:r.Song,Track:u.Track,Part:i.Part,Instrument:g.Instrument,SimpleSynth:a.SimpleSynth,Sampler:p.Sampler,log:function(t){switch(t){case"functions":console.log("functions:\n          getAudioContext\n          getMasterVolume\n          setMasterVolume\n          getMIDIAccess\n          getMIDIInputs\n          getMIDIOutputs\n          getMIDIInputIds\n          getMIDIOutputIds\n          getMIDIInputsById\n          getMIDIOutputsById\n          parseMIDIFile\n          setBufferTime\n          getInstruments\n          getGMInstruments\n        ")}}};t["default"]=f,t.version=S,t.init=M.init,t.getInstruments=e.getInstruments,t.getGMInstruments=e.getGMInstruments,t.updateSettings=e.updateSettings,t.getSettings=e.getSettings,t.MIDIEventTypes=l.MIDIEventTypes,t.parseSamples=d.parseSamples,t.parseMIDIFile=o.parseMIDIFile,t.getAudioContext=v,t.getMasterVolume=m.getMasterVolume,t.setMasterVolume=m.setMasterVolume,t.getMIDIAccess=D.getMIDIAccess,t.getMIDIInputs=D.getMIDIInputs,t.getMIDIOutputs=D.getMIDIOutputs,t.getMIDIInputIds=D.getMIDIInputIds,t.getMIDIOutputIds=D.getMIDIOutputIds,t.getMIDIInputsById=D.getMIDIInputsById,t.getMIDIOutputsById=D.getMIDIOutputsById,t.getNoteData=n.getNoteData,t.MIDIEvent=s.MIDIEvent,t.MIDINote=I.MIDINote,t.Song=r.Song,t.Track=u.Track,t.Part=i.Part,t.Instrument=g.Instrument,t.SimpleSynth=a.SimpleSynth,t.Sampler=p.Sampler});
