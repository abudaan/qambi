...
!function(t,e){if("function"==typeof define&&define.amd)define(["exports","./note","./settings"],e);else if("undefined"!=typeof exports)e(exports,require("./note"),require("./settings"));else{var i={exports:{}};e(i.exports,t.note,t.settings),t.midi_event=i.exports}}(this,function(t,e,i){"use strict";function n(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(t,"__esModule",{value:!0}),t.MIDIEvent=void 0;var s=function(){function t(t,e){for(var i=0;i<e.length;i++){var n=e[i];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(e,i,n){return i&&t(e.prototype,i),n&&t(e,n),e}}(),o=0;t.MIDIEvent=function(){function t(s,a,r){var u=arguments.length<=3||void 0===arguments[3]?-1:arguments[3];arguments.length<=4||void 0===arguments[4]?0:arguments[4];if(n(this,t),this.id=this.constructor.name+"_"+o++ +"_"+(new Date).getTime(),this.ticks=s,this.type=a,this.data1=r,this.data2=u,this.pitch=(0,i.getSettings)().pitch,144===a&&0===u&&(this.type=128),this._part=null,this._track=null,this._song=null,144===a||128===a){var h=(0,e.getNoteData)({number:r});this.noteName=h.name,this.fullNoteName=h.fullName,this.frequency=h.frequency,this.octave=h.octave}}return s(t,[{key:"copy",value:function(){var e=new t(this.ticks,this.type,this.data1,this.data2);return e}},{key:"transpose",value:function(t){this.data1+=t,this.frequency=this.pitch*Math.pow(2,(this.data1-69)/12)}},{key:"updatePitch",value:function(t){t!==this.pitch&&(this.pitch=t,this.transpose(0))}},{key:"move",value:function(t){this.ticks+=t,this.midiNote&&this.midiNote.update()}},{key:"moveTo",value:function(t){this.ticks=t,this.midiNote&&this.midiNote.update()}}]),t}()});
...
!function(e,r){if("function"==typeof define&&define.amd)define(["exports","isomorphic-fetch","./midifile","./midi_event","./part","./track","./song","./util","./fetch_helpers","./settings"],r);else if("undefined"!=typeof exports)r(exports,require("isomorphic-fetch"),require("./midifile"),require("./midi_event"),require("./part"),require("./track"),require("./song"),require("./util"),require("./fetch_helpers"),require("./settings"));else{var t={exports:{}};r(t.exports,e.isomorphicFetch,e.midifile,e.midi_event,e.part,e.track,e.song,e.util,e.fetch_helpers,e.settings),e.song_from_midifile=t.exports}}(this,function(e,r,t,n,i,a,o,s,u,c){"use strict";function f(e){return e&&e.__esModule?e:{"default":e}}function l(e){v=(0,c.getSettings)().ppq;var r=e.tracks,t=e.header.ticksPerBeat,s=v/t,u=[],f=-1,l=-1,p=-1,d=[],m=!0,h=!1,y=void 0;try{for(var I,g=r.values()[Symbol.iterator]();!(m=(I=g.next()).done);m=!0){var b=I.value,k=void 0,w=void 0,M=0,_=void 0,q=-1,x=void 0,D=void 0,E=[],B=!0,F=!1,S=void 0;try{for(var N,P=b[Symbol.iterator]();!(B=(N=P.next()).done);B=!0){var T=N.value;switch(M+=T.deltaTime*s,-1===q&&"undefined"!=typeof T.channel&&(q=T.channel),_=T.subtype,T.subtype){case"trackName":x=T.text;break;case"instrumentName":T.text&&(D=T.text);break;case"noteOn":E.push(new n.MIDIEvent(M,144,T.noteNumber,T.velocity));break;case"noteOff":E.push(new n.MIDIEvent(M,128,T.noteNumber,T.velocity));break;case"setTempo":var A=6e7/T.microsecondsPerBeat;M===k&&_===w&&u.pop(),-1===f&&(f=A),u.push(new n.MIDIEvent(M,81,A));break;case"timeSignature":k===M&&w===_&&(console.info("time signature events on the same tick",M,T.numerator,T.denominator),u.pop()),-1===l&&(l=T.numerator,p=T.denominator),u.push(new n.MIDIEvent(M,88,T.numerator,T.denominator));break;case"controller":E.push(new n.MIDIEvent(M,176,T.controllerType,T.value));break;case"programChange":E.push(new n.MIDIEvent(M,192,T.programNumber));break;case"pitchBend":E.push(new n.MIDIEvent(M,224,T.value))}w=_,k=M}}catch(O){F=!0,S=O}finally{try{!B&&P["return"]&&P["return"]()}finally{if(F)throw S}}E.length>0&&d.push(new a.Track({name:x,parts:[new i.Part({events:E})]}))}}catch(O){h=!0,y=O}finally{try{!m&&g["return"]&&g["return"]()}finally{if(h)throw y}}var U=new o.Song({ppq:v,playbackSpeed:1,bpm:f,nominator:l,denominator:p,tracks:d,timeEvents:u});return U.update(),U}function p(e){var r=(arguments.length<=1||void 0===arguments[1]?{}:arguments[1],null);if(e instanceof ArrayBuffer==!0){var n=new Uint8Array(e);r=l((0,t.parseMIDIFile)(n))}else if("undefined"!=typeof e.header&&"undefined"!=typeof e.tracks)r=l(e);else if(e=(0,s.base64ToBinary)(e),e instanceof ArrayBuffer==!0){var i=new Uint8Array(e);r=l((0,t.parseMIDIFile)(i))}else console.error("wrong data");return r}function d(e){return new Promise(function(r,t){(0,m["default"])(e).then(u.status).then(u.arrayBuffer).then(function(e){r(p(e))})["catch"](function(e){t(e)})})}Object.defineProperty(e,"__esModule",{value:!0}),e.songFromMIDIFileSync=p,e.songFromMIDIFile=d;var m=f(r),v=void 0});
