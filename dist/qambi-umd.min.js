...
!function(e,t){if("function"==typeof define&&define.amd)define(["exports","./init_audio","./parse_audio"],t);else if("undefined"!=typeof exports)t(exports,require("./init_audio"),require("./parse_audio"));else{var n={exports:{}};t(n.exports,e.init_audio,e.parse_audio),e.convolution_reverb=n.exports}}(this,function(e,t,n){"use strict";function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(e,"__esModule",{value:!0}),e.ConvolutionReverb=void 0;var o=function(){function e(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}();e.ConvolutionReverb=function(){function e(n){i(this,e),this._nodeFX=t.context.createConvolver(),n instanceof AudioBuffer&&(this._nodeFX.buffer=n),this.input=t.context.createGain(),this.output=t.context.createGain(),this._dry=t.context.createGain(),this._wet=t.context.createGain(),this._dry.gain.value=1,this._wet.gain.value=0,this.input.connect(this._dry),this._dry.connect(this.output),this.input.connect(this._nodeFX),this._nodeFX.connect(this._wet),this._wet.connect(this.output),this.amount=0}return o(e,[{key:"addBuffer",value:function(e){return e instanceof AudioBuffer==!1?void console.log("argument is not an instance of AudioBuffer",e):void(this._nodeFX.buffer=e)}},{key:"loadBuffer",value:function(e){var t=this;return new Promise(function(i,o){(0,n.parseSamples)(e).then(function(n){n=n[0],n instanceof AudioBuffer?(t._nodeFX.buffer=n,i()):o("could not parse to AudioBuffer",e)})})}},{key:"setAmount",value:function(e){0>e?e=0:e>1&&(e=1),this.amount=e,this._wet.gain.value=this.amount,this._dry.gain.value=1-this.amount}}]),e}()});
...
!function(e,t){if("function"==typeof define&&define.amd)define(["exports","./settings","./note","./midi_event","./midi_note","./part","./track","./song","./instrument","./sampler","./simple_synth","./convolution_reverb","./midifile","./init","./init_audio","./init_midi","./parse_audio","./constants","./eventlistener"],t);else if("undefined"!=typeof exports)t(exports,require("./settings"),require("./note"),require("./midi_event"),require("./midi_note"),require("./part"),require("./track"),require("./song"),require("./instrument"),require("./sampler"),require("./simple_synth"),require("./convolution_reverb"),require("./midifile"),require("./init"),require("./init_audio"),require("./init_midi"),require("./parse_audio"),require("./constants"),require("./eventlistener"));else{var n={exports:{}};t(n.exports,e.settings,e.note,e.midi_event,e.midi_note,e.part,e.track,e.song,e.instrument,e.sampler,e.simple_synth,e.convolution_reverb,e.midifile,e.init,e.init_audio,e.init_midi,e.parse_audio,e.constants,e.eventlistener),e.qambi=n.exports}}(this,function(e,t,n,s,I,i,r,u,o,g,p,a,M,m,D,d,l,v,c){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.ConvolutionReverb=e.Sampler=e.SimpleSynth=e.Instrument=e.Part=e.Track=e.Song=e.MIDINote=e.MIDIEvent=e.getNoteData=e.getMIDIOutputsById=e.getMIDIInputsById=e.getMIDIOutputIds=e.getMIDIInputIds=e.getMIDIOutputs=e.getMIDIInputs=e.getMIDIAccess=e.setMasterVolume=e.getMasterVolume=e.getAudioContext=e.parseMIDIFile=e.parseSamples=e.MIDIEventTypes=e.getSettings=e.updateSettings=e.getGMInstruments=e.getInstruments=e.init=e.version=void 0;var S="1.0.0-beta29",f=function(){return D.context},y={version:S,updateSettings:t.updateSettings,getSettings:t.getSettings,getNoteData:n.getNoteData,init:m.init,setBufferTime:t.setBufferTime,MIDIEventTypes:v.MIDIEventTypes,parseSamples:l.parseSamples,parseMIDIFile:M.parseMIDIFile,getAudioContext:f,getMasterVolume:D.getMasterVolume,setMasterVolume:D.setMasterVolume,getMIDIAccess:d.getMIDIAccess,getMIDIInputs:d.getMIDIInputs,getMIDIOutputs:d.getMIDIOutputs,getMIDIInputIds:d.getMIDIInputIds,getMIDIOutputIds:d.getMIDIOutputIds,getMIDIInputsById:d.getMIDIInputsById,getMIDIOutputsById:d.getMIDIOutputsById,getInstruments:t.getInstruments,getGMInstruments:t.getGMInstruments,addEventListener:function(e,t){return(0,c.addEventListener)(e,t)},removeEventListener:function(e,t){(0,c.removeEventListener)(e,t)},MIDIEvent:s.MIDIEvent,MIDINote:I.MIDINote,Song:u.Song,Track:r.Track,Part:i.Part,Instrument:o.Instrument,SimpleSynth:p.SimpleSynth,Sampler:g.Sampler,ConvolutionReverb:a.ConvolutionReverb,log:function(e){switch(e){case"functions":console.log("functions:\n          getAudioContext\n          getMasterVolume\n          setMasterVolume\n          getMIDIAccess\n          getMIDIInputs\n          getMIDIOutputs\n          getMIDIInputIds\n          getMIDIOutputIds\n          getMIDIInputsById\n          getMIDIOutputsById\n          parseMIDIFile\n          setBufferTime\n          getInstruments\n          getGMInstruments\n        ")}}};e["default"]=y,e.version=S,e.init=m.init,e.getInstruments=t.getInstruments,e.getGMInstruments=t.getGMInstruments,e.updateSettings=t.updateSettings,e.getSettings=t.getSettings,e.MIDIEventTypes=v.MIDIEventTypes,e.parseSamples=l.parseSamples,e.parseMIDIFile=M.parseMIDIFile,e.getAudioContext=f,e.getMasterVolume=D.getMasterVolume,e.setMasterVolume=D.setMasterVolume,e.getMIDIAccess=d.getMIDIAccess,e.getMIDIInputs=d.getMIDIInputs,e.getMIDIOutputs=d.getMIDIOutputs,e.getMIDIInputIds=d.getMIDIInputIds,e.getMIDIOutputIds=d.getMIDIOutputIds,e.getMIDIInputsById=d.getMIDIInputsById,e.getMIDIOutputsById=d.getMIDIOutputsById,e.getNoteData=n.getNoteData,e.MIDIEvent=s.MIDIEvent,e.MIDINote=I.MIDINote,e.Song=u.Song,e.Track=r.Track,e.Part=i.Part,e.Instrument=o.Instrument,e.SimpleSynth=p.SimpleSynth,e.Sampler=g.Sampler,e.ConvolutionReverb=a.ConvolutionReverb});
