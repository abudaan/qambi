...
var Track = exports.Track = function () {
  ...
  function Track() {
    ...
    this.muted = false;
    this.volume = 0.5;
    this._panner = _init_audio.context.createStereoPanner();
  ...
  _createClass(Track, [{
    ...
    */
    ...
    value: function setPanning(value) {
      if (value < -1 || value > 1) {
        console.log('Track.setPanning() accepts a value between -1 and 1, you entered:', value);
        return;
      }
      var x = value;
      var y = 0;
