...
var Song = exports.Song = function () {
  ...
  _createClass(Song, [{
    ...
    value: function update() {
      ...
      var noteOn = new _midi_event.MIDIEvent(0, _qambi.MIDIEventTypes.NOTE_ON, 60, 100);
      var noteOff = new _midi_event.MIDIEvent(0, _qambi.MIDIEventTypes.NOTE_OFF, 60, 0);
      noteOn.id = 'dummy';
      noteOff.id = 'dummy';
      noteOn._track = { id: 'dummy' };
      noteOff._track = { id: 'dummy' };
      (0, _parse_events.parseEvents)([this._timeEvents[0], noteOn, noteOff]);
    }
  }, {
    key: 'play',
