...
document.addEventListener('DOMContentLoaded', function () {
  ...
  _qambi2.default.init().then(function () {
    ...
    _qambi.Song.fromMIDIFileAsync('../data/minute_waltz.mid').then(function (song) {
      ...
      piano.parseSampleData({ url: 'https://raw.githubusercontent.com/abudaan/qambi-instruments/master/heartbeat/electric-piano.json' }).then(function () {
        song.play();
      });
    });
  });
