  ...
  _createClass(Song, [{
    ...
    value: function update2() {
      ...
      if (this._updateEvents) {
        this._allEvents = (0, _parse_events.parseEvents)([].concat(_toConsumableArray(this._timeEvents), _toConsumableArray(this._events)));
        (0, _parse_events.parseMIDINotes)(this._events);
        // this._allEvents.forEach(e => {
        //   if(e._track === null || e._part === null){
        //     console.log(e)
        //   }
        // })
        ...
        console.log(lastEvent, this._durationMillis);
      }
    }
  }, {
    key: 'addTimeEvents',
