...
var _convolution_reverb = require('../../src/convolution_reverb');

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } } // use "from 'qambi'" in your own code! so without the extra "../../"
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function initUI(song) {
    ...
    var hasReverb = false;
    var reverb = void 0;
    _convolution_reverb.ConvolutionReverb.load('../data/100-Reverb.mp3').then(function (r) {
      reverb = r;
...
},{"../../src/convolution_reverb":7,"../../src/qambi":25}],2:[function(require,module,exports){
/* FileSaver.js
...
},{"./init_audio":11}],6:[function(require,module,exports){
'use strict';
...
},{"./channel_fx":5,"./init_audio":11,"./parse_audio":20}],8:[function(require,module,exports){
'use strict';
...
},{"./constants":6,"./init_audio":11,"./midi_event":15,"./parse_events":21,"./part":22,"./position":24,"./sampler":29,"./track":38,"./util":39}],15:[function(require,module,exports){
'use strict';
...
},{"./eventlistener":8,"./init_audio":11,"./util":39,"isomorphic-fetch":3}],21:[function(require,module,exports){
'use strict';
...
},{"./constants":6,"./eventlistener":8,"./init":10,"./init_audio":11,"./init_midi":12,"./instrument":13,"./midi_event":15,"./midi_note":16,"./midifile":18,"./note":19,"./parse_audio":20,"./part":22,"./sampler":29,"./settings":33,"./simple_synth":34,"./song":35,"./track":38}],26:[function(require,module,exports){
'use strict';
...
},{"filesaverjs":2}],32:[function(require,module,exports){
'use strict';
...
},{"./constants":6,"./eventlistener":8,"./init_audio":11,"./metronome":14,"./midi_event":15,"./parse_events":21,"./playhead":23,"./position":24,"./save_midifile":31,"./scheduler":32,"./settings":33,"./song.update":36,"./song_from_midifile":37,"./util":39}],36:[function(require,module,exports){
'use strict';
...
},{"./constants":6,"./eventlistener":8,"./midi_event":15,"./parse_events":21,"./position":24,"./util":39}],37:[function(require,module,exports){
'use strict';
...
},{"./fetch_helpers":9,"./midi_event":15,"./midifile":18,"./part":22,"./settings":33,"./song":35,"./track":38,"./util":39,"isomorphic-fetch":3}],38:[function(require,module,exports){
'use strict';
