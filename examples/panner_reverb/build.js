...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function initUI(song) {
    ...
    var hasReverb = false;
    var reverb = new _convolution_reverb.ConvolutionReverb();
    reverb.loadBuffer('../data/100-Reverb.mp3').then(function (r) {
...
},{"../../src/convolution_reverb":15,"../../src/qambi":33}],3:[function(require,module,exports){
/* FileSaver.js
...
},{"./constants":14,"./eventlistener":16,"./init":18,"./init_audio":19,"./init_midi":20,"./instrument":21,"./midi_event":23,"./midi_note":24,"./midifile":26,"./note":27,"./parse_audio":28,"./part":30,"./sampler":37,"./settings":41,"./simple_synth":42,"./song":43,"./track":46}],34:[function(require,module,exports){
'use strict';
