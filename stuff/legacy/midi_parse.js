...
import createMIDIStream from './midi_stream';
...
export default function parseMIDIFile(buffer){
  let tracks = new Map();
  let stream = createMIDIStream(new Uint8Array(buffer));
  ...
  let headerStream = createMIDIStream(headerChunk.data);
  ...
  for(let i = 0; i < trackCount; i++){
    ...
    let trackStream = createMIDIStream(trackChunk.data);
