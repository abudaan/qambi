...
document.addEventListener('DOMContentLoaded', function(){
  ...
  if(test === 3){
    ...
    qambi.getAudioContext().decodeAudioData(base64ToBinary(base64),
      function(buffer){
        console.log(buffer)
        instrument.addSampleData(50, {
          buffer,
          // release: [4, 'linear'],
          release: [4, envelope],
        })
    ...
    //   buffer: '../data/TP01d-ElectricPiano-000-060-c3.wav',
    //   sustain: [0],
